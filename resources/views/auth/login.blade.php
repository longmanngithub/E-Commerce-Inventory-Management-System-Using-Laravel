<x-guest-layout>
    <div x-data="{
        email: '{{ old('owner_email') }}',
        password: '{{ old('owner_password') }}',
        ...
        init() {
            // Restore form state on viewport changes
            window.addEventListener('resize', () => {
                this.$nextTick(() => {
                    this.$refs.emailInput.value = this.email;
                    this.$refs.passwordInput.value = this.password;
                    this.$refs.rememberInput.checked = this.remember;
                });
            });
        }
    }">
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-6">
            ...
            <!-- Email Address -->
            <div>
                <label for="owner_email" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                    Email Address
                </label>
            ...
            <!-- Password -->
            <div>
                <label for="owner_password" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                    Password
                </label>
                <div class="relative">
                    ...
                    <button type="button"
                            ...
                            @touchstart.passive=""
                            class="absolute inset-y-0 right-0 flex items-center px-3 text-gray-400 hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-300 focus:outline-none touch-manipulation"
