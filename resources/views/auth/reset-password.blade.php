    ...
    <div x-data="{
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div>
                ...
                <x-text-input id="email" class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-400 dark:focus:border-blue-400 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 transition duration-200" type="email" name="email" :value="old('email', $email)" readonly />
