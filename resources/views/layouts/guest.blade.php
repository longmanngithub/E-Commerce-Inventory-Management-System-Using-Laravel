...
<div class="hidden lg:grid lg:grid-cols-2 lg:items-center min-h-screen">
    ...
    <div class="w-full h-full bg-white dark:bg-gray-900 py-8 ps-8">
        <div class="rounded-3xl bg-sky-200/50 h-full" style="background-image: url('../../storage/background-image/background2.jpg'); object-fit: cover; background-repeat: no-repeat; background-size: cover; background-position: center;">
{{--            <img class="w-full h-full object-cover rounded-3xl opacity-90" src="storage/background-image/background2.jpg" alt="background image">--}}
        </div>
    </div>
